...
<div class="breadcrumbs">
    <div class="container">
      <p><span><a href="index.php">Home</a></span> <span><img src="img/arrow-point-to-right.png"></span> <span><a href="rms-pos.php">Retail management solutions / POS</a></span> <span><img src="img/arrow-point-to-right.png"></span> <span>kiosk food ordering</span></p>
    </div>
  </div>
...
<!--<div class="our-vert">
  <p class="our-vert-click">Store Types<img src="img/up-arrow.png" alt="Down"></p>
...
<section class="food-ordering">
	<div class="container text-center">
		<div class="row">
			...
			<div class="col-md-12 text-center">
				<img src="img/food-ordering-features.png" class="d-block mx-auto food-ord-img" alt="Food ordering kiosk">
