...
fbq('init', '180931712619728');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=180931712619728&ev=PageView&noscript=1"
/></noscript>
<!-- DO NOT MODIFY -->
         ...
         <div class="bfastmag-breaking-container"><ul class="bfastmag-breaking">
            ...
            <div class="inner-header clearfix">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 navbar-brand">
                  <div class="site-branding">
                    ...
                    if ( function_exists( 'the_custom_logo' ) && has_custom_logo() ) :
                        ...
                        echo '<h1 itemprop="headline" id="site-title" class="site-title"><a href="https://www.albertapayments.com" title="' . esc_attr( get_bloginfo( 'name', 'display' ) ) . '" rel="home">' . get_bloginfo( 'name' ) . '</a></h1>';
                        ...
                        echo '</div>';
                            ...
                            echo '<h1 itemprop="headline" id="site-title" class="site-title"><a href="https://www.albertapayments.com" title="' . esc_attr( get_bloginfo( 'name', 'display' ) ) . '" rel="home">' . esc_attr( get_bloginfo( 'name' ) ) . '</a></h1>';
                            echo '<p itemprop="description" id="site-description" class="site-description">' . esc_attr( get_bloginfo( 'description' ) ) . '</p>';
                            echo '</div>';
				...
				jQuery(document).ready(function() {
				 ...
				 jQuery('a.custom-logo-link').attr('href' , 'https://www.albertapayments.com');
            ...
            <div id="navbar" class="navbar <?php if ( isset( $bfastmag_sticky_menu ) && $bfastmag_sticky_menu == false ) { echo 'bfastmag-sticky';} ?>">
              ...
              <nav id="site-navigation" class="navigation main-navigation" role="navigation">
				...
				<div class="col-md-2"><a href="tel:888-502-6650" class="white">Demo: (888) 502 6650</a></div>
